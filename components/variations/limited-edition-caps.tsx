    ...
    <section className="py-20 bg-gradient-to-br from-[#F7F9FA] to-[#E8F1FA]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-[#6B9DCB] to-[#A7C7E7] bg-clip-text text-transparent">
          ...
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
              <div className={`${currentCap.color} p-12 flex items-center justify-center relative`}>
                {currentCap.limited && (
                  <div className="absolute top-4 right-4 bg-white text-[#6B9DCB] px-3 py-1 rounded-full text-sm font-bold flex items-center space-x-1 shadow-lg">
              ...
              <div className="p-12 flex flex-col justify-center">
                ...
                <div className="bg-gradient-to-r from-[#E8F1FA] to-[#F7F9FA] rounded-xl p-4 mb-6">
                  <p className="text-sm text-gray-700">
                    <span className="font-bold text-[#6B9DCB]">Handcrafted Design:</span> Each cap is carefully
                ...
                <div className="flex items-center justify-between pt-6 border-t border-gray-200">
                  ...
                  <div className="flex space-x-2">
                    <button
                      onClick={prevSlide}
                      className="w-10 h-10 bg-[#6B9DCB] hover:bg-[#588DBA] text-white rounded-full flex items-center justify-center transition-colors"
            ...
            {limitedEditionCaps.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-all ${
                  index === currentIndex ? 'bg-[#6B9DCB] w-8' : 'bg-gray-300 hover:bg-gray-400'
                }`}
